<template>
  <main class="invoice">
    <section>
      <textarea class="invoice-from u-text-right " rows="1" :placeholder="invoiceTemplate.executive" v-model="invoiceTemplate.executive"></textarea>
      <textarea class="invoice-to u-text-left" rows="7" :placeholder="invoiceTemplate.recipient" v-model="invoiceTemplate.recipient"></textarea>
    </section>
    <section class="invoice-data">
      <textarea class="u-text-center invoice-header" rows="1" :placeholder="invoiceTemplate.invoiceTitle" v-model="invoiceTemplate.invoiceTitle"></textarea>
      ...
      <div class="invoice-calc">
        <div class="invoice-calc-row invoice-calc-row__header">
          <textarea rows="1" class="invoice-calc-input invoice-calc-number" :placeholder="invoiceTemplate.labels.nrLabel"></textarea>
          <textarea rows="1" class="invoice-calc-input invoice-calc-name" :placeholder="invoiceTemplate.labels.serviceNameLabel"></textarea>
          <textarea rows="1" class="invoice-calc-input invoice-calc-count" :placeholder="invoiceTemplate.labels.ammountLabel"></textarea>
          <textarea rows="1" class="invoice-calc-input invoice-calc-price-netto" :placeholder="invoiceTemplate.labels.priceNettoLabel"></textarea>
          <textarea rows="1" class="invoice-calc-input invoice-calc-value-netto" :placeholder="invoiceTemplate.labels.valueNettoLabel"></textarea>
          <textarea rows="1" class="invoice-calc-input invoice-calc-vat" :placeholder="invoiceTemplate.labels.valRateLabel"></textarea>
          <textarea rows="1" class="invoice-calc-input invoice-calc-vat-value" :placeholder="invoiceTemplate.labels.valValueLabel"></textarea>
          <textarea rows="1" class="invoice-calc-input invoice-calc-full-value" :placeholder="invoiceTemplate.labels.fullValueLabel"></textarea>
        </div>
      ...
      <section class="invoice-summary">
        <span rows="1" class="invoice-summary-row u-bold invoice-calc-label">Do zapłaty: {{ bruttoValue }} zł</span>
        <textarea rows="1" class="invoice-summary-row u-text-xs" :placeholder="invoiceTemplate.valueInWords" v-model="invoiceTemplate.valueInWords"></textarea>
        <textarea rows="1" class="invoice-summary-row u-bold u-mt-15" :placeholder="invoiceTemplate.paymentType" v-model="invoiceTemplate.paymentType"></textarea>
        <textarea rows="1" class="invoice-summary-row u-text-xs" :placeholder="invoiceTemplate.accountNumber" v-model="invoiceTemplate.accountNumber"></textarea>
      </section>
    </section>
